...
You’ll see the case dossier below.

**Your role**  
You can influence the **Housekeeper** (the witness). Write one instruction; it shapes the Housekeeper’s testimony and their answers to the Detective’s questions.
